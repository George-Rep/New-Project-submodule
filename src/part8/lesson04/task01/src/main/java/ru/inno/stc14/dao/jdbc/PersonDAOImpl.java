...
public class PersonDAOImpl implements PersonDAO {
    ...
    private static final String INSERT_PERSON_SQL_TEMPLATE =
            resource.getResourceBundleString("PersonDAOImpl.statement.insert");
    private static final String SELECT_PERSON_SQL_TEMPLATE =
            resource.getResourceBundleString("PersonDAOImpl.statement.select");
     ...
     *
     */
    public PersonDAOImpl(ServletContext ctx) {
    ...
    public List<Person> getList() {
        ...
        try (PreparedStatement statement = connection.prepareStatement(SELECT_PERSON_SQL_TEMPLATE)) {
            ...
            logger.log(Level.SEVERE, resource.getResourceBundleString("PersonDAOImpl.logmessage"), e);
        }
        return result;
    }
    /**
