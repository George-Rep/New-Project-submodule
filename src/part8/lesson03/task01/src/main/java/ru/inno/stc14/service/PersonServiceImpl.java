...
public class PersonServiceImpl implements PersonService {
    ...
    private Date safeParseDate(String birthStr) {
        DateFormat format = new SimpleDateFormat(resource.getResourceBundleString("PersonServiceImpl.dateformat"));
        try {
            return format.parse(birthStr);
        } catch (ParseException e) {
            logger.log(Level.SEVERE, resource.getResourceBundleString("PersonServiceImpl.logmessage"), e);
